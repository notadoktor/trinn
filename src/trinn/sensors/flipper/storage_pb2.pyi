...
class File(google.protobuf.message.Message):
    ...
    size: int
    data: bytes
    def __init__(self, *, type: FileType=..., name: str=..., size: int=..., data: bytes=...) -> None: ...
...
class StatResponse(google.protobuf.message.Message):
    ...
    file: trinn.sensors.flipper.storage_pb2.File
    def __init__(self, *, file: trinn.sensors.flipper.storage_pb2.File=...) -> None: ...
...
class WriteRequest(google.protobuf.message.Message):
    ...
    path: str
    file: trinn.sensors.flipper.storage_pb2.File
    def __init__(self, *, path: str=..., file: trinn.sensors.flipper.storage_pb2.File=...) -> None: ...
